...
def player_fetch(z,name):
    ...
    # To evaluate 2017 and 2018 seasons
    player_career = player_career[-3:-1]
...
z = 0
# Gather testing data
with open('trainX.csv',mode='w') as train:
    writer = csv.writer(train, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL, lineterminator='\n')
...
with open('testX.csv', mode='w') as test1:
    writer = csv.writer(test1, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL, lineterminator='\n')
